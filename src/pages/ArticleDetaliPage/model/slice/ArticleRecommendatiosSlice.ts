...
export const getArticleRecommends = recommendAdapter.getSelectors<StateSchema>(
    (state) =>
        state.articleDetaliPage?.recommendations ||
...
const ArticleRecommendatiosSlice = createSlice({
    ...
    extraReducers: (builder) => {
        builder
            ...
            .addCase(
                ArticleRecommendsThunk.fulfilled,
...
export const { actions: ArticleRecommendatiosActions } =
    ArticleRecommendatiosSlice
export const { reducer: ArticleRecommendatiosReducer } =
    ArticleRecommendatiosSlice
