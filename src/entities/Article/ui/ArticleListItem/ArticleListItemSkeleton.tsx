...
export const ArticleListItemSkeleton = memo((props: ArticleListItemSkeletonProps) => {
    ...
    if (view === ArticleView.BIG) {
        return (
            <div className={classNames(styles.ArticleListItemSkeleton, {}, [className, styles.BIG])}>
                <Card>
    ...
    return (
        <div className={classNames(styles.ArticleListItemSkeleton, {}, [className, styles.SMALL])}>
            <Card>
