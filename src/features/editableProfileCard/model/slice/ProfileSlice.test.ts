...
describe('ProfileSlice', () => {
    ...
    test('pending', () => {
        ...
        expect(
            ProfileReducer(state as ProfileCardSchema, ProfileThunk.pending)
    ...
    test('rejected', () => {
        const state: DeepPartial<ProfileCardSchema> = {}
        expect(
            ProfileReducer(state as ProfileCardSchema, ProfileThunk.rejected)
        ).toEqual({
            isLoading: false,
        })
    })
