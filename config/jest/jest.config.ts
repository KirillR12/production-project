...
export default {
    ...
    // cacheDirectory: "/private/var/folders/3p/7rqvz9qd5_18pdbn9bvnzp_m0000gn/T/jest_dx",
    ...
    // A list of paths to modules that run some
    // code to configure or set up the testing framework before each test
    // setupFilesAfterEnv: [],

    // The number of seconds after which a test
    // is considered as slow and reported as such in the results.
    // slowTestThreshold: 5,
    ...
    // An array of regexp patterns that are matched
    // against all source file paths before re-running tests in watch mode
